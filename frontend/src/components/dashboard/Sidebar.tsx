...
export function Sidebar({ projects = [] }: SidebarProps) {
  ...
  return (
    <aside className="w-[220px] min-h-screen bg-[#111113] border-r border-white/5 flex flex-col flex-shrink-0">
      {/* Logo */}
      <div className="px-4 pt-5 pb-4 flex items-center gap-2">
        <div className="w-7 h-7 rounded-lg bg-gradient-to-br from-violet-500 to-pink-500 flex items-center justify-center text-white font-bold text-xs">
          F
        </div>
        <span className="font-semibold text-white text-sm">Fluxyn</span>
      </div>
